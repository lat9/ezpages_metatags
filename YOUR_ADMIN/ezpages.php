...
//-bof-ezpages_metatags-lat9  *** 1 of 6 ***
      // -----
...
//-eof-ezpages_metatags-lat9  *** 1 of 6 ***
...
//-bof-ezpages_metatags-lat9  *** 2 of 6 ***
...
//-eof-ezpages_metatags-lat9  *** 2 of 6 ***
...
//-bof-ezpages_metatags-lat9  *** 3 of 6 ***
...
//-eof-ezpages_metatags-lat9  *** 3 of 6 ***
...
//-bof-ezpages_metatags-lat9  *** 4 of 6 ***
        $zco_notifier->notify('NOTIFY_ADMIN_EZPAGES_NEW', '', $parameters);
//-eof-ezpages_metatags-lat9  *** 4 of 6 ***
...
<?php
//-bof-ezpages_metatags-lat9  *** 5 of 6 ***
        // -----
...
//-eof-ezpages_metatags-lat9  *** 5 of 6 ***
?>
        <div class="form-group">
...
<?php
//-eof-ezpages_metatags-lat9  *** 6 of 6 ***
                    // -----
                    // Give a watching observer the chance to insert another icon/link to the standard list of 'action' icons.
                    //
                    // Note that the first parameter will be set to (bool)false if no $ezInfo object is available (i.e. there
                    // are currently no EZ-Pages defined for the store.).
                    //
                    $extra_action_icons = '';
